...
export class HomePage {
  ...
  constructor(private router: Router, private newsService: NewsService, private loadingCtrl: LoadingController, private behaviorsService: BehaviorsService) {
    this.defaultImage = './../../../../assets/images/no_image.jpeg';
    behaviorsService.user.subscribe((userValue) => {
      this.user = userValue;
      if(this.user.id) this.userIsLogged = true; else this.userIsLogged = false;
